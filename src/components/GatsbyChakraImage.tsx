...
const GatsbyChakraImage = forwardRef<CustomBadgeProps, "span">((props, ref) => {
    ...
    // 
    // <Logo style={{ 'filter': `${filter}` }} alt="Logo" height={54} width={50} />

    return <chakra.span ref={ref}><StaticImage style={{ 'filter': `${filter}` }} src="../images/logo.png" alt="Logo" width={50} /></chakra.span>;
});
